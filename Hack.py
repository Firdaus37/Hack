...
def login():
    ...
    try:
        ...
        id = raw_input('\x1b[1;91m[+] \x1b[1;36mEmail/No FB \x1b[1;91m:\x1b[1;92m ')
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://youtube.com/D4U515')
                time.sleep(2)
                menu()
            ...
            if zedd == '2':
                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            os.system('rm -rf login.txt')
                            os.system('xdg-open https://www.youtube.com/D4U515')
                            keluar()
                        else:
                            if zedd == '0':
                                keluar()
